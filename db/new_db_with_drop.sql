...
DROP TABLE "patents";
DROP TABLE "phd_committe_members";
...
DROP TABLE "research_project_members";
...
"date" TEXT NOT NULL,
PRIMARY KEY ("id") ,
CONSTRAINT "fk_best_paper_awards_publications_1" FOREIGN KEY ("publication_id") REFERENCES "publications" ("id")
);
...
CONSTRAINT "fk_examinations_courses_taught_1" FOREIGN KEY ("course_id") REFERENCES "courses_taught" ("id")
);
...
PRIMARY KEY ("id") ,
CONSTRAINT "fk_industry_collaboration_companies_1" FOREIGN KEY ("company_id") REFERENCES "companies" ("id"),
...
PRIMARY KEY ("id") ,
CONSTRAINT "fk_research_projects_grants_1" FOREIGN KEY ("grant_id") REFERENCES "grants" ("id")
);
